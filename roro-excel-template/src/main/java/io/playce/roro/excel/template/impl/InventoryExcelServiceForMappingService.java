...
package io.playce.roro.excel.template.impl;

import io.playce.roro.common.dto.inventory.inventory.InventoryUploadFail;
import io.playce.roro.excel.template.AbstractInventoryExcelService;
...
public class InventoryExcelServiceForMappingService extends AbstractInventoryExcelService {
    ...
    public void validationServiceServerMapping(String sheetName, ServiceMaster mappingServiceMaster,
                                               InventoryMaster mappingInventoryMaster, List<InventoryUploadFail> validationList) {
