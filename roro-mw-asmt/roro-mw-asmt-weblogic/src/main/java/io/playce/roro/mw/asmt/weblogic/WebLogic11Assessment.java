 ...
 */
@Slf4j
@Component("WEBLOGIC11Assessment")
public class WebLogic11Assessment extends WebLogicAssessment {

    public WebLogic11Assessment(CommandConfig commandConfig, WebLogicHelper webLogicHelper) {
...
//end of WebLogicAssessment11.java