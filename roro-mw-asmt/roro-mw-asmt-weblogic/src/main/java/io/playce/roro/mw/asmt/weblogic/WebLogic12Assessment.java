 ...
 */
@Slf4j
@Component("WEBLOGIC12Assessment")
public class WebLogic12Assessment extends WebLogicAssessment {
    public WebLogic12Assessment(CommandConfig commandConfig, WebLogicHelper webLogicHelper) {
...
//end of WebLogicAssessment12.java