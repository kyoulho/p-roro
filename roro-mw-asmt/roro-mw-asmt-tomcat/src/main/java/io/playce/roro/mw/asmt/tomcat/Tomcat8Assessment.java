 ...
 * @version 3.0
 */
@Component("TOMCAT8Assessment")
public class Tomcat8Assessment extends TomcatAssessment{
    public Tomcat8Assessment(ProcessRemote processRemote, ProcessLocal processLocal, ProcessJson processJson, CommandConfig commandConfig) {
        super(processRemote, processLocal, processJson, commandConfig);
    }
}
//end of TomcatAssessment8.java