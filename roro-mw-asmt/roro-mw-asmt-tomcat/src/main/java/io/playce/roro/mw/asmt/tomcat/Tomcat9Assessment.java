 ...
 * @version 3.0
 */
@Component("TOMCAT9Assessment")
public class Tomcat9Assessment extends TomcatAssessment {

    public Tomcat9Assessment(ProcessRemote processRemote, ProcessLocal processLocal, ProcessJson processJson, CommandConfig commandConfig) {
        super(processRemote, processLocal, processJson, commandConfig);
    }
}
//end of TomcatAssessment9.java