 ...
 * @version 3.0
 */
@Component("TOMCAT85Assessment")
public class Tomcat85Assessment extends TomcatAssessment {
    public Tomcat85Assessment(ProcessRemote processRemote, ProcessLocal processLocal, ProcessJson processJson, CommandConfig commandConfig) {
        super(processRemote, processLocal, processJson, commandConfig);
    }
}
//end of Tomcat8_5.java