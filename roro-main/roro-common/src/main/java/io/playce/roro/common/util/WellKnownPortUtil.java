 ...
 * ---------------	----------------	------------
 * SangCheon Park   Feb 10, 2021		First Draft.
 */
...
public class WellKnownPortUtil {
    ...
    public static String getType(String protocol, Integer port) {
        return getType(protocol, port, "Custom");
    }
     ...
     * @return the type
     */
    public static String getType(String protocol, Integer port, String defaultValue) {
        String type = null;
