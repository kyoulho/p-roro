 ...
 * ---------------	----------------	------------
 * SangCheon Park   Mar 25, 2022		    First Draft.
 */
...
@Getter
@Setter
public class DiscoveredDatabaseDetailResponse {
    ...
    private Integer discoveredServicePort;
    private String databaseServiceName;
    private String jdbcUrl;
    private String userName;
    private Date registDatetime;
}
//end of DiscoveredDatabaseDetailResponse.java