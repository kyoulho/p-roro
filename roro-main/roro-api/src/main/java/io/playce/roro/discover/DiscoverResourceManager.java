 ...
 * ---------------  ----------------    ------------
 * Hoon Oh       2월 09, 2022            First Draft.
 */
package io.playce.roro.discover;
...
public class DiscoverResourceManager {

    private final UnknownServerDiscoverHelper unkSvrHelper;
    private final UnknownMiddlewareDiscoverHelper unkMwHelper;
    private final UnknownDatabaseDiscoverHelper unkDBHelper;

    public void discover(InventoryProcessConnectionInfo connectionInfo, ServerAssessmentResult result) throws InterruptedException {
        ...
        log.debug("[InventoryProcess-{}] inventoryProcess start extract unknown middleware", connectionInfo.getInventoryProcessId());
        unkMwHelper.extract(connectionInfo, result, strategy);
        log.debug("[InventoryProcess-{}] inventoryProcess end extract unknown middleware", connectionInfo.getInventoryProcessId());
...
//end of DiscoverResourceManager.java