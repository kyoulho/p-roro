 ...
 * @version 1.0
 */
public class WebSphereEnginePathScenario extends ExtractScenario {
    @Override
    protected boolean extract(Process process, CommandConfig commandConfig, GetInfoStrategy strategy) {
        result = ProcessCmdUtil.getParam(process.getCmd(),"-Dwas.install.root");
        return StringUtils.isNotEmpty(result);
    }
}
//end of WebSphereSolutionPathScenario.java