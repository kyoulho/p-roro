 ...
 * @version 1.0
 */
public class TomcatEnginePathScenario {

    // 1. Process Command에서 -Dcatalina.home 인자 추출
    public static class Step1 extends ExtractScenario {
        ...
        protected boolean extract(Process process, CommandConfig commandConfig, GetInfoStrategy strategy) {
           result = ProcessCmdUtil.getParam(process.getCmd(), "-Dcatalina.home");
    ...
    public static class Step2 extends ExtractScenario {
        ...
        protected boolean extract(Process process, CommandConfig commandConfig, GetInfoStrategy strategy) {
            ...
            //     String output = SSHUtil.executeCommand(TargetHost.convert(unknownMiddleware.getServer()), command);
            //
...
//end of TomcatSolutionPathScenario.java