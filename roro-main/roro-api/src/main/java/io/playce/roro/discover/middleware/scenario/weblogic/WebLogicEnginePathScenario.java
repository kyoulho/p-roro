 ...
 * @version 1.0
 */
public class WebLogicEnginePathScenario extends ExtractScenario {
    @Override
    protected boolean extract(Process process, CommandConfig commandConfig, GetInfoStrategy strategy) {
        result = ProcessCmdUtil.getParam(process.getCmd(),"-Dweblogic.home");
        return StringUtils.isNotEmpty(result);
    }
}
//end of WebSolutionPathScenario.java