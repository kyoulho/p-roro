package io.playce.roro.api.domain.survey.controller;
...
class SurveyControllerTest {
    ...
    @Test
    void 설문내용조회() throws Exception {
        mockMvc.perform(get("/api/cloud-readiness/surveys/{surveyId}/questions", 1)
    ...
    @Test
    void 설문결과목록조회() throws Exception {
        mockMvc.perform(get("/api//projects/{projectId}/cloud-readiness/answers", 1)
                        .header(HttpHeaders.AUTHORIZATION, accessToken)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andDo(print())
                .andExpect(status().isOk())
