 ...
 */
@Repository
public interface ServerSummaryRepository extends JpaRepository<ServerSummary, Long>, JpaSpecificationExecutor<ServerSummary> {

    Optional<ServerSummary> findByServerInventoryId(Long inventoryId);
