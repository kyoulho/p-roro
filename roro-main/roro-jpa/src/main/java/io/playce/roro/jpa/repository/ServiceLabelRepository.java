 ...
 */
@Repository
public interface ServiceLabelRepository extends JpaRepository<ServiceLabel, Long>, JpaSpecificationExecutor<ServiceLabel> {
    void deleteAllByServiceId(Long serviceId);
}
//end of ServiceLabelRepository.java