...
@Component("REDHAT8Assessment")
public class RedHat8ServerAssessment extends RedHatServerAssessment {
    public RedHat8ServerAssessment(DistributionConfig config) {
        super(config);
    }
