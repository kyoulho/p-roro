...
@Slf4j
@Component("OLAssessment")
public class OracleLinuxServerAssessment extends RedHatServerAssessment {

    public OracleLinuxServerAssessment(DistributionConfig config) {
        super(config);
    }
