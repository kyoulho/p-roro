 ...
 * @version 1.0
 */
@Component("REDHAT7Assessment")
public class RedHat7ServerAssessment extends RedHatServerAssessment {
    public RedHat7ServerAssessment(DistributionConfig config) {
        super(config);
    }
...
//end of RedHatServerAssessment7.java