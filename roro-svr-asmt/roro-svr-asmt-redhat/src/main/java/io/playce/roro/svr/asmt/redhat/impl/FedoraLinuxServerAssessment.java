...
@Slf4j
@Component("FEDORAAssessment")
public class FedoraLinuxServerAssessment extends RedHatServerAssessment {

    public FedoraLinuxServerAssessment(DistributionConfig config) {
        super(config);
    }
