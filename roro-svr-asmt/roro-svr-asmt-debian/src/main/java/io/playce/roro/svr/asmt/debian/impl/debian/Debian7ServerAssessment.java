 ...
 * @version 1.0
 */
@Component("DEBIAN7Assessment")
public class Debian7ServerAssessment extends DebianServerAssessment {
    public Debian7ServerAssessment(DistributionConfig config) {
        super(config);
    }
...
//end of DebianServerAssessment7.java