 ...
 * @version 1.0
 */
@Component("DEBIANAssessment")
@RequiredArgsConstructor
public class DebianServerAssessment extends LinuxServerAssessment {
    private final DistributionConfig config;

    @Override
    public Map<String, String> generateCommand() {
        Map<String, String> generateCommand = super.generateCommand();
        generateCommand.put(AssessmentItems.PACKAGES.toString(), DebianAsmtCommand.PACKAGES);
    ...
    public DebianAssessmentResult assessment(TargetHost targetHost) throws InterruptedException {
        ...
        return DebianAssessmentResult.builder()
...
//end of DebianServerAssessment.java