 ...
 * @version 1.0
 */
@Component("UBUNTU1404Assessment")
public class Ubuntu1404ServerAssessment extends UbuntuServerAssessment {
    public Ubuntu1404ServerAssessment(DistributionConfig config) {
        super(config);
    }
...
//end of UbuntuServerAssessment14_04.java