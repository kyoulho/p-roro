 ...
 * @version 1.0
 */
@Component("UBUNTU1604Assessment")
public class Ubuntu1604ServerAssessment extends UbuntuServerAssessment {
    public Ubuntu1604ServerAssessment(DistributionConfig config) {
        super(config);
    }
...
//end of UbuntuServerAssessment16_04.java