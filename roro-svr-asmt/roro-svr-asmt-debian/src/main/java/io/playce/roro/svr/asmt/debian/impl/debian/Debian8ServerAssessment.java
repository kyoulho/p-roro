 ...
 * @version 1.0
 */
@Component("DEBIAN8Assessment")
public class Debian8ServerAssessment extends DebianServerAssessment {
    public Debian8ServerAssessment(DistributionConfig config) {
        super(config);
    }
...
//end of DebianServerAssessment8.java