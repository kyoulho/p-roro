 ...
 * @version 1.0
 */
@Component("UBUNTU1610Assessment")
public class Ubuntu1610ServerAssessment extends UbuntuServerAssessment {

    public Ubuntu1610ServerAssessment(DistributionConfig config) {
        super(config);
    }
...
//end of UbuntuServerAssessment16_10.java