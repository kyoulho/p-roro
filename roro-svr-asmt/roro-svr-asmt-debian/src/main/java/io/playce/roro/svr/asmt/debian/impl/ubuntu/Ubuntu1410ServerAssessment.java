 ...
 * @version 1.0
 */
@Component("UBUNTU1410Assessment")
public class Ubuntu1410ServerAssessment extends UbuntuServerAssessment {
    public Ubuntu1410ServerAssessment(DistributionConfig config) {
        super(config);
    }
...
//end of UbuntuServerAssessment14_10.java