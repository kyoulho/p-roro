ALTER TABLE DISCOVERED_PORT_RELATION MODIFY PROTOCOL VARCHAR(100) NULL COMMENT '프로토콜';
ALTER TABLE MIDDLEWARE_INSTANCE_PROTOCOL MODIFY PROTOCOL VARCHAR(100) NULL COMMENT '프로토콜';
